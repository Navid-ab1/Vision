...
for i in range(4):
    cv2.circle(I1, np.uint8((points1[i, 0], points1[i, 1])), 3, [0, 0, 255], 2)
    cv2.circle(I2, np.uint8((points2[i, 0], points2[i, 1])), 3, [0, 0, 255], 2)
...
#
# # Apply the inverse transformation to I2
# J_inv = cv2.warpPerspective(I2, H_inv, (I1.shape[1], I1.shape[0]))
#
# # Display the result
# cv2.imshow('I1', I1)
# cv2.imshow('I2', I2)
# cv2.imshow('J_inv', J_inv)
# cv2.waitKey(0)
